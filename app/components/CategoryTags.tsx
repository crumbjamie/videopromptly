...
import { ChevronDown, Check, Search, Folder } from 'lucide-react';
          ...
          <div className="max-h-64 overflow-y-auto">
            <div className="p-2">
              ...
              >
                ...
                {selectedCategories.length === 0 && <Check className="w-4 h-4" />}
              </button>
            </div>

            <div className="border-t border-stone-800 p-2">
              {filteredCategories.length === 0 ? (
                <p className="text-center text-stone-500 py-4 text-sm">No categories found</p>
              ) : (
